...
// Theme colors: primary (blue-500), secondary (accent-pink), dark backgrounds, rounded corners, subtle borders
...
export default function FileUpload({
    ...
    const [status, setStatus] = useState<"idle"|"dragging"|"uploading"|"error">("idle");
    ...
    return (
        ...
        >
            <div className="group relative w-full rounded-xl bg-background ring-1 ring-primary/10 p-0.5">
                <div className="absolute inset-x-0 -top-px h-px w-full bg-gradient-to-r from-transparent via-primary/20 to-transparent" />
                <div className="relative w-full rounded-[10px] bg-muted/50 dark:bg-white/[0.02] p-1.5">
                    <div
                        className={cn(
                            "relative mx-auto w-full overflow-hidden rounded-lg border border-primary/10 bg-background",
                                ...
                                {(status === "idle" || status === "dragging") && (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className="w-4/5 flex items-center justify-center gap-2 rounded-lg bg-muted px-4 py-2.5 text-sm font-semibold text-foreground transition-all duration-200 hover:bg-primary/10 group"
                                        >
                                            <span>Upload File</span>
                                            <UploadCloud className="w-4 h-4 group-hover:scale-110 transition-transform duration-200 text-primary" />
                                        </button>
                                ...
                                {status === "uploading" && (
                                    ...
                                    >
                                        ...
                                        <button
                                            onClick={resetState}
                                            type="button"
                                            className="w-4/5 flex items-center justify-center gap-2 rounded-lg bg-muted px-4 py-2.5 text-sm font-semibold text-foreground transition-all duration-200 hover:bg-primary/10"
                                        >
                                            Cancel
                                        </button>
                                    </motion.div>
